...
export default function profIntro(state) {
  ...
  messages = [
    ...messages,
    'I am a web developer with 7 years of experience. Throughout my career I was mostly focusing on frontend development, with a heavy emphasis on javascript, although I love css and html with all my heart.',
