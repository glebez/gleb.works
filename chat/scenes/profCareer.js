...
export default function profCareer() {
  const messages = [
    ...
    'My longest collaboration is with Sinnerschrader, where I was employed till March 2022. My total run there was more than 5 years, although I have left a company for a year in the middle to pursue other opportunities.',
